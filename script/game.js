...
var main = function() {
  ...
  $(document).on('click', '#spapButton', function() {
    ...
    switch(currentRole) {
      case 'Merlin':
        roleStatement = roleStatement.concat("You are the <span class='resistance'>Merlin</span><br><br>The spies are:");
        var tempArray = [];
        for(var i = 0; i < numSpies; i++) {
      ...
      case 'Percival':
        ...
        break;
      case 'Mordred':
        roleStatement = roleStatement.concat("You are the <span class='spy'>Mordred</span><br> The spy team is:");
        ...
        break;
      case 'Morgana':
        roleStatement = roleStatement.concat("You are the <span class='spy'>Morgana</span><br> The spy team is:");
        for(var i = 0; i < spyArray.length; i++) {
          var index = spyArray[i];
          roleStatement = roleStatement.concat(playerArr[index] + " ");
        }
      ...
      case 'Spy1':
      case 'Spy2':
        roleStatement = roleStatement.concat("You are a regular <span class= 'spy'>spy</span>. <br>The spy team is:");
        for(var i = 0; i < spyArray.length; i++) {
          var index = spyArray[i];
          roleStatement = roleStatement.concat(playerArr[index] + " ");
        }
    ...
    roleStatement = roleStatement.concat("</div><div id='buttonStatment' class = 'wrapper'><br><button id='toggle' class='myButton'>Show/Hide role</button><br><br>");
  ...
  $(document).on('click','#beginGame',function() {
    ...
    var gameTemplate = "<div id='game' class='wrapper'><div id='missions class='wrapper'> </div></div>";
    $("#all").fadeOut("slow", function () {
